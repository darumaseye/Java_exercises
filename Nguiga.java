   ...
   while(true){ 
	    ...
	    if (game_mode.equals("typing")){
			...
			do{
				...
				if(chosen_word.equals("menù")||chosen_word.equals("exit"))
					System.out.println(chosen_word+" is a Nguiga keyword, youcan't use it, choose another please.");
				if(chosen_word.equals("exit"))
					System.exit(0);
				if(chosen_word.equals("menù"))
					continue start;
			}while(!chosen_word.equals("calc")&&!chosen_word.equals("typing")&&!chosen_word.equals("menù")&&!chosen_word.equals("exit"));
